...
public class ModifyProductForm implements Initializable {
    ...
    /**
     * initialize the form, set up the two table views, and load data from the selected product.
     *
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        selectedProduct = MainForm.selectedProduct;

        associatedParts = selectedProduct.getAllAssociatedParts();

        idText.setText(String.valueOf(selectedProduct.getId()));
        nameText.setText(selectedProduct.getName());
        inventoryText.setText(String.valueOf(selectedProduct.getStock()));
     ...
     *
     * @param actionEvent the event triggered by the Add Part button
     */
     ...
     * associated with the Product. The associatedPartsTable view is then updated.
     *
     * @param actionEvent the event triggered by the Remove Part button
     */
     ...
     * then added to the inventory. The original product is then deleted.
    ...
    public void onSave(ActionEvent actionEvent) {
        int newProductId = selectedProduct.getId();
